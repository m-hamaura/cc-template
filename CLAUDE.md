...
### devcontainer環境でのOllama接続

devcontainerからホストマシンのOllamaに接続する設定：
...
2. **接続設定**
   - devcontainer.jsonで自動的に `OLLAMA_URL=http://host.docker.internal:11434` が設定されます
